...
async function seed() {
  ...
  console.log('  Owner:          abc / Abc@123');
  console.log('  All India Mgr:  arjun.aim / AIM@2026');
  console.log('  Regional Mgr:   rajesh.north / North@123');
  console.log('  Zonal Mgr:      amit.up / Zone@123');
  console.log('  Area Mgr:       ravi.lko / Area@123');
  console.log('  Vendor:         mahesh.vendor / Vendor@123');
}
